...
// [REMOVED] PointCloud2 模式不需要 Livox CustomMsg 处理函数
/*
...
// [REMOVED] PointCloud2 模式不需要 Livox avia_handler
// 该函数依赖 livox_ros_driver2::msg::CustomMsg 的 .points[].line .tag .reflectivity .offset_time 字段
/*
