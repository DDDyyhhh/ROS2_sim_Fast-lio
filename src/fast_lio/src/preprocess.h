...
POINT_CLOUD_REGISTER_POINT_STRUCT(velodyne_ros::PointXYZIR,
                                  (float, x, x)(float, y, y)(float, z, z)(float, intensity,
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // void process(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);  // [REMOVED] PointCloud2 模式
...
private:
  // void avia_handler(const livox_ros_driver2::msg::CustomMsg::UniquePtr &msg);  // [REMOVED] PointCloud2 模式
