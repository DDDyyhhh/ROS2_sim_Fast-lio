...
class PathExecutor(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('checkpoint_file', state_file('coverage_checkpoint.json'))
    ...
    def _save_checkpoint(self):
        ...
        try:
            ensure_parent(self.checkpoint_file)
    ...
    def _load_checkpoint(self):
        """加载断点"""
        checkpoint_file = readable_path(
            self.checkpoint_file, 'coverage_checkpoint.json')
